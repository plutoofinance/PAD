...
:root {{
  ...
  --gradient-blue: linear-gradient(135deg, #1e3a5f, #0e7490);
  --code-bg: #0d1117;
}}
...
.data-table tr.row-amber td {{ background: rgba(245,158,11,0.06); }}
.data-table tr.row-green td {{ background: rgba(16,185,129,0.06); }}
.data-table tr.row-blue td {{ background: rgba(56,189,248,0.06); }}
.data-table tr.row-red td {{ background: rgba(239,68,68,0.06); }}
...
.chip.blue {{ background: rgba(56,189,248,0.12); color: var(--accent-blue); border: 1px solid rgba(56,189,248,0.2); }}
.chip.amber {{ background: rgba(245,158,11,0.12); color: var(--accent-amber); border: 1px solid rgba(245,158,11,0.2); }}
.chip.green {{ background: rgba(16,185,129,0.12); color: var(--accent-green); border: 1px solid rgba(16,185,129,0.2); }}
.chip.red {{ background: rgba(239,68,68,0.12); color: var(--accent-red); border: 1px solid rgba(239,68,68,0.2); }}
.chip.purple {{ background: rgba(167,139,250,0.12); color: var(--accent-purple); border: 1px solid rgba(167,139,250,0.2); }}
.chip.muted {{ background: rgba(255,255,255,0.06); color: var(--text-secondary); border: 1px solid var(--border); }}
...
.pipeline-node.blue {{ border-color: rgba(56,189,248,0.3); }}
.pipeline-node.blue .node-num {{ color: var(--accent-blue); }}
.pipeline-node.purple {{ border-color: rgba(167,139,250,0.3); }}
...
.pipeline-node.amber {{ border-color: rgba(245,158,11,0.3); }}
...
.col-header.red {{ background: rgba(239,68,68,0.1); color: var(--accent-red); }}
...
.rec-card-header.red {{ background: rgba(239,68,68,0.12); color: var(--accent-red); }}
.rec-card-header.blue {{ background: rgba(56,189,248,0.12); color: var(--accent-blue); }}
.rec-badge {{
  display: inline-block; padding: 3px 10px; border-radius: 20px;
  font-size: 11px; font-weight: 600; margin-bottom: 6px;
}}
.rec-badge.green {{ background: rgba(16,185,129,0.15); color: var(--accent-green); }}
.rec-badge.red {{ background: rgba(239,68,68,0.15); color: var(--accent-red); }}
.rec-badge.blue {{ background: rgba(56,189,248,0.15); color: var(--accent-blue); }}
...
.cat-tag.reativacao {{ background: rgba(239,68,68,0.12); color: var(--accent-red); }}
...
.budget-segment.amber {{ background: rgba(245,158,11,0.2); color: var(--accent-amber); flex: 50; }}
...
.budget-segment.blue {{ background: rgba(56,189,248,0.12); color: var(--accent-blue); flex: 15; }}
